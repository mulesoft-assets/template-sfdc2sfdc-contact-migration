...
public class DateUtilsTest {
	...
	// String dateB = "2013-12-09T22:15:33.001Z";
	//
	// Assert.assertTrue("The contact A should be after the contact B",
	// DateUtils.isAfter(dateA, dateB));
	// }
	//
	// @Test
	...
	// String dateB = "2013-12-09T22:15:33.001Z";
	//
	// Assert.assertFalse("The contact A should not be after the contact B",
	// DateUtils.isAfter(dateA, dateB));
	// }
	//
	// @Test
	...
	//
	// @Test
	// public void dateAIsTheSameThatdateBInDifferentTimezone() throws
	// TransformerException {
	// String dateA = "2013-12-09T01:00:33.001-03:00";
	// String dateB = "2013-12-09T07:00:33.001+03:00";
	//
	// Assert.assertFalse("The date A should not be after the date B as they are the same ",
	// DateUtils.isAfter(dateA, dateB));
	// }
	//
	// @Test
	// public void dateAIsAfterThedateBInDifferentTimezone() throws
	// TransformerException {
	// String dateA = "2013-12-09T02:00:33.001-03:00";
	// String dateB = "2013-12-09T07:00:33.001+03:00";
	//
	// Assert.assertTrue("The date A should be after the date B",
	// DateUtils.isAfter(dateA, dateB));
	// }
	//
	// @Test
	// public void dateAIsBeforeThedateBInDifferentTimezone() throws
	// TransformerException {
	// String dateA = "2013-12-09T01:00:33.001-03:00";
	// String dateB = "2013-12-09T08:00:33.001+03:00";
	//
	// Assert.assertFalse("The date A should be after the date B",
	// DateUtils.isAfter(dateA, dateB));
	// }
	//
	// @Test
	// public void dateAIsTheSameThatdateBInDifferentTimezoneZulu() throws
	// TransformerException {
	// String dateA = "2013-12-09T01:00:33.001-03:00";
	...
	//
	// @Test
	// public void dateAIsAfterThedateBInDifferentTimezoneZulu() throws
	// TransformerException {
	// String dateA = "2013-12-09T02:00:33.001-03:00";
	// String dateB = "2013-12-09T04:00:33.001Z";
	//
	...
	//
	// @Test
	// public void dateAIsBeforeThedateBInDifferentTimezoneZulu() throws
	// TransformerException {
	// String dateA = "2013-12-09T02:00:33.001-03:00";
	...
	public void toIsoDateWithNoFormatWithNoOffset() throws TransformerException {
		...
		// String dateA = "2013-12-09T02:00:33.001-03:00";
		// String dateA = "2014-05-29 12:13:25.0"; // what comes from mysql
		// // String dateA = "2014-05-29T12:13:25.001-03:00";
		// String dateB = "2014-05-29T15:13:25.001Z";

		// System.out.println(new Timestamp(1401376405000l).set);
		// Assert.assertFalse("The date A should be after the date B",
		// DateUtils.isAfter(dateA, dateB));
	}
